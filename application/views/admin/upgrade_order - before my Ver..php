                          ...
                          <div class="panel-body">
                            <div class="col-sm-7">                              
                              <div class="row">
                                <div class="col-sm-5">
                                  <div class="form-group">
                                    <div class="checkbox"><label><input type="checkbox" name="check_additional_a_basic">Basic A</label></div>
                                  </div>
                                </div>
                                <div class="col-sm-7">
                                  <div class="form-inline">
                                    <div class="form-group">
                                      <select name="additional_hari_a_basic" class="form-control input-sm">
                                    ...
                                    <div class="form-group">
                                      <div class="input-group">
                                        ...
                                        <input type="number" name="additional_harga_a_basic" class="form-control input-sm" step="100" placeholder="Harga Basic A">
                                      </div>
                                    </div>
                                  </div>   
                                </div>
                              ...
                              <div class="row">
                                <div class="col-sm-5">
                                  <div class="form-group">
                                    <div class="checkbox"><label><input type="checkbox" name="check_additional_b_basic">Basic B <small class="help-block">(Dengan Medium Body)</small>
                                    </label></div>
                                  </div>
                                </div>
                                <div class="col-sm-7">
                                  <div class="form-inline">
                                    <div class="form-group">
                                      <select name="additional_hari_b_basic" class="form-control input-sm">
                                        <?php for ($i=0.25; $i<1.25 ; $i=$i+0.25) { ?>
                                          <option value="<?php echo $i?>"><?php echo $i?> Hari</option>
                                        <?php } ?>
                                      </select>
                                    ...
                                    <div class="form-group">
                                      <div class="input-group">
                                        <span class="input-group-addon">Rp</span>
                                        <input type="number" name="additional_harga_b_basic" class="form-control input-sm" step="100" placeholder="Harga Basic B">
                                      </div>
                                    </div>
                                  </div>   
                                </div>
                              ...
                              <div class="row">
                                <div class="col-sm-5">
                                  <div class="form-group">
                                    <div class="checkbox"><label><input type="checkbox" name="check_additional_a_standard">Standard A</label></div>
                                  </div>
                                </div>
                                <div class="col-sm-7">
                                  <div class="form-inline">
                                    <div class="form-group">
                                      <select name="additional_hari_a_standard" class="form-control input-sm">
                                        <?php for ($i=0.25; $i<1.25 ; $i=$i+0.25) { ?>
                                          <option value="<?php echo $i?>"><?php echo $i?> Hari</option>
                                        <?php } ?>
                                      </select>
                                    ...
                                    <div class="form-group">
                                      <div class="input-group">
                                        <span class="input-group-addon">Rp</span>
                                        <input type="number" name="additional_harga_a_standard" class="form-control input-sm" step="100" placeholder="Harga Standard A">
                                      </div>
                                    </div>
                                  </div>   
                                </div>
                              ...
                              <div class="row">
                                <div class="col-sm-5">
                                  <div class="form-group">
                                    <div class="checkbox"><label><input type="checkbox" name="check_additional_b_standard">Standard B <small class="help-block">(Dengan Medium Body)</small></label></div>
                                  </div>
                                </div>
                                <div class="col-sm-7">
                                  <div class="form-inline">
                                    <div class="form-group">
                                      <select name="additional_hari_b_standard" class="form-control input-sm">
                                        <?php for ($i=0.25; $i<1.25 ; $i=$i+0.25) { ?>
                                          <option value="<?php echo $i?>"><?php echo $i?> Hari</option>
                                        <?php } ?>
                                      </select>
                                    ...
                                    <div class="form-group">
                                      <div class="input-group">
                                        <span class="input-group-addon">Rp</span>
                                        <input type="number" name="additional_harga_b_standard" class="form-control input-sm" step="100" placeholder="Harga Standard B">
                                      </div>
                                    </div>
                                  </div>   
                                </div>
                              ...
                              <div class="row">
                                <div class="col-sm-5">
                                  <div class="form-group">
                                    <div class="checkbox"><label><input type="checkbox" name="check_additional_a_premium">Premium A</label></div>
                                  </div>
                                </div>
                                <div class="col-sm-7">
                                  <div class="form-inline">
                                    <div class="form-group">
                                      <select name="additional_hari_a_premium" class="form-control input-sm">
                                        <?php for ($i=0.25; $i<1.25 ; $i=$i+0.25) { ?>
                                          <option value="<?php echo $i?>"><?php echo $i?> Hari</option>
                                        <?php } ?>
                                      </select>
                                    ...
                                    <div class="form-group">
                                      <div class="input-group">
                                        <span class="input-group-addon">Rp</span>
                                        <input type="number" name="additional_harga_a_premium" class="form-control input-sm" step="100" placeholder="Harga Premium A">
                                      </div>
                                    </div>
                                  </div>   
                                </div>
                              ...
                              <div class="row">
                                <div class="col-sm-5">
                                  <div class="form-group">
                                    <div class="checkbox"><label><input type="checkbox" name="check_additional_b_premium">Premium B <small class="help-block">(Dengan Medium Body)</small></label></div>
                                  </div>
                                </div>
                                <div class="col-sm-7">
                                  <div class="form-inline">
                                    <div class="form-group">
                                      <select name="additional_hari_b_premium" class="form-control input-sm">
                                        <?php for ($i=0.25; $i<1.25 ; $i=$i+0.25) { ?>
                                          <option value="<?php echo $i?>"><?php echo $i?> Hari</option>
                                        <?php } ?>
                                      </select>
                                    ...
                                    <div class="form-group">
                                      <div class="input-group">
                                        <span class="input-group-addon">Rp</span>
                                        <input type="number" name="additional_harga_b_premium" class="form-control input-sm" step="100" placeholder="Harga Premium B">
                                      </div>
                                    </div>
                                  </div>   
                                </div>
